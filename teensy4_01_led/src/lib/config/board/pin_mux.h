...
#define BOARD_INITPINS_LED_PORT                                            GPIO2   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_LED_PIN                                                3U   /*!< PORT pin number */
#define BOARD_INITPINS_LED_PIN_MASK                                   (1U << 3U)   /*!< PORT pin mask */
